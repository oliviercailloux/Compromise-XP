...
\begin{theorem}
	...
	\begin{enumerate}
		...
		\item \label{it:t2143} $0 ≤ t_2 - t_1 - 2 - (t_4 - t_3 - 1)$;
		\item \label{it:t3m4} $0 ≤ m - t_3 - t_4$;
...
\begin{proof}
	...
	\begin{itemize}
		...
		\item \Cref{it:t43} comes from \cref{it:torder}.
		\item \Cref{it:t2143} is equivalent to \cref{it:t1423}.
		\item \Cref{it:t3m4} is equivalent to \cref{it:t34m}.
		\item Adding \cref{it:t2143,it:t43} yield $0 ≤ t_2 - t_1 - 2$, equivalently, \cref{it:t12}.
		\item Using \cref{it:t3m4} together with \cref{it:t1423} yields $t_1 ≤ - t_4 - 1 + t_2 + m - t_4$, equivalently, \cref{it:t1m42}.
