...
\begin{enumerate}
	...
	\item whether $x$ is also the (sole) Borda winner, $x$ is one of the Borda winners, or neither.
\end{enumerate}
...
here are the possible relationships between $B(\prof)$ and $\FBP = \set{x}$ (\cref{rk:BFB}):
\begin{itemize}
...
The profiles in \crefrange{ex:0657}{ex:0548} all satisfy $B(\prof) = \FBP = \set{x}$ and are generated using the process described in \cref{th:B} and illustrated in \cref{ex:profs}.
...
\begin{enumerate}
	...
	\begin{itemize}
		\item {}[0324 (\ref{ex:0324}) or 0526 (\ref{ex:0526})] VS 0657 (\ref{ex:0657})
		\item or any other $\delta = 1$ VS 0657 (\ref{ex:0657})
	\end{itemize}
	\item Does it matter for the FB winner to be top-ranked by a voter? 
	\begin{itemize}
		\item 0324 (\ref{ex:0324}) VS 1435 (\ref{ex:1435}, if we choose the version $B(\prof) = \set{x}$)
		\item 0526 (\ref{ex:0526}) VS 1637 (\ref{ex:1637}, if we choose the version $B(\prof) = \set{x}$, not taken)
	\end{itemize}
	\item Does the best position of the FB winner matter?
	\begin{itemize}
		\item 0324 (\ref{ex:0324}) VS 3657 (\ref{ex:3657}, if we choose the version $B(\prof) = \set{x}$)
	\end{itemize}
	\item Does $d(\lprof(y))$ matter, fixing $\delta$?
	\begin{itemize}
		\item{} [0546 (\ref{ex:0546}) or 1657 (\ref{ex:1657}, if we choose the version $B(\prof) = \set{x}$)] VS 0647 (\ref{ex:0647})
	\end{itemize}
...
\end{enumerate}
As a consequence, we pick the following set of seven profiles: $\set{0324 (\ref{ex:0324}), 0526 (\ref{ex:0526}), 0657 (\ref{ex:0657}), \allowbreak 1435 (\ref{ex:1435}), \allowbreak 3657 (\ref{ex:3657}), \allowbreak 0546 (\ref{ex:0546}), 0647 (\ref{ex:0647})}$ (the example numbers are relevant only if we choose the version $B(\prof) = \set{x}$).

Other possible questions (not considered for now).
