...
\end{theorem}
\begin{proof}
	$2 ≤ 2 + t_1 ≤ t_2$ by \cref{th:B} (proof) \cref{it:t12}, with $t_2 + 1 ≤ t_3 ≤ t_4 - 1$ hence $t_2 + 2 ≤ t_4$, we obtain \cref{it:t4}.
	From \cref{th:sufficientBounds} \cref{it:t1423}, $t_4 ≤ t_3 - t_1 + t_2 - 1$ and from \cref{it:torder}, $t_2 ≤ t_3 - 1$, whence, using $- \min \lprof(x) ≤ 0$, $t_4 ≤ t_3  + t_3 - 2$, which also gives (together with \cref{it:t34m}, $t_3 ≤ m - t_4$) $t_4 ≤ 2 m - 2 t_4 - 2$, equivalently, \cref{it:t4}.
