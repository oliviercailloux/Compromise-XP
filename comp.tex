...
\begin{proof}[to be checked]
	...
	\begin{description}
		...
		\item[$\ibar$] $(A_1^{-1}, y, A_2, x, A_3, A_5, A_4)$.
	\end{description}
	...
	Finally, $\forall z \in A_4$, $d(\lprof(z)) = \card{(A_1 \cup \set{y} \cup A_2 \cup \set{x} \cup A_3 \cup A_5)} > m - t_4 - t_1 > t_4 - t_2$.
	...
	$\forall z \in A_4$, $\sum \lprof(z) ≥ \card{(A_1 \cup \set{y} \cup A_2 \cup \set{x} \cup A_3 \cup A_5)} = \card{\allalts \setminus A_4} = m - t_1$.
	Wanted: $m - t_1 > t_1 + t_3$.
	Fails for $m = 22, t_1 = 7, t_2 = 9, t_3 = 10, t_4 = 11$.
%{
%	\tiny
%	\begin{equation}
%		\begin{array}{*{16}c}
