...
\begin{table}
	...
	\begin{tabular}{CCCCCCCCCC}
		\toprule
		\scriptscriptstyle d(\lprof(x)) & \scriptscriptstyle d(\lprof(y)) & v(x) & v(y) & e & \Delta^\text{min} & \Delta^\text{avg} & \delta&\text{top}&\text{cl}\\
		\midrule
		\DTLforeach*{m13}{%
			\rowdlPx=dlPx,%
			\rowdlPy=dlPy,%
