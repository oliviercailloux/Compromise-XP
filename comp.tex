...
\begin{table}
	\begin{tabular}{CCCCCCCCCCC}
		\toprule
		\text{id} & \scriptscriptstyle d(\lprof(x)) & \scriptscriptstyle d(\lprof(y)) & v(x) & v(y) & e & \text{top} & \Delta^\text{min} & \Delta^\text{avg} & \delta&\text{cl}\\
		\midrule 
		\csvreader[late after line = \\\bottomrule]{Profiles.csv}%
...
\begin{table}
	...
	\DTLnewdb{m13}
	\DTLnewrow{m13}
	\DTLnewdbentry{m13}{dlPx}{6}
	\DTLnewdbentry{m13}{dlPy}{5}
	\DTLnewdbentry{m13}{maxlPx}{6}
	\DTLnewdbentry{m13}{maxlPy}{7}
	\DTLnewrow{m13}
	\DTLnewdbentry{m13}{dlPx}{5}
	\DTLnewdbentry{m13}{dlPy}{4}
	\DTLnewdbentry{m13}{maxlPx}{5}
	\DTLnewdbentry{m13}{maxlPy}{6}
	\DTLnewrow{m13}
	\DTLnewdbentry{m13}{dlPx}{4}
	\DTLnewdbentry{m13}{dlPy}{3}
	\DTLnewdbentry{m13}{maxlPx}{4}
	\DTLnewdbentry{m13}{maxlPy}{5}
	\DTLnewrow{m13}
	\DTLnewdbentry{m13}{dlPx}{3}
	\DTLnewdbentry{m13}{dlPy}{2}
	\DTLnewdbentry{m13}{maxlPx}{3}
	\DTLnewdbentry{m13}{maxlPy}{4}
	\DTLnewrow{m13}
	\DTLnewdbentry{m13}{dlPx}{6}
	\DTLnewdbentry{m13}{dlPy}{4}
	\DTLnewdbentry{m13}{maxlPx}{6}
	...
	\begin{tabular}{CCCCCCCCCCC}
		\toprule
		\scriptscriptstyle d(\lprof(x)) & \scriptscriptstyle d(\lprof(y)) & v(x) & v(y) & e & \text{top} & \Delta^\text{min} & \Delta^\text{avg} & \delta&\text{cl}&\text{expl}\\
		\midrule
		\DTLforeach*{m13}{%
			\rowdlPx=dlPx,%
			\rowdlPy=dlPy,%
			...
			\FPdiv\rowavglPx{\rowsumlPx}{2}%
			(\num{\rowminlPx}, \num{\rowmaxlPx}, \num[round-precision = 1]{\rowavglPx}) & %
			\FPsub\rowminlPy{\rowmaxlPy}{\rowdlPy}%
			\FPadd\rowsumlPy{\rowminlPy}{\rowmaxlPy}%
			\FPdiv\rowavglPy{\rowsumlPy}{2}%
			\dtlifnumgt{\rowsumlPy}{12}{!!}{}%
			(\num{\rowminlPy}, \num{\rowmaxlPy}, \num[round-precision = 1]{\rowavglPy}) & %
			\FPmul\rowtworhos{\rowmaxlPx}{2}%
			\FPsub\rowe{12}{\rowtworhos}%
			\num{\rowe} & %
			\FPsub\rowminlPx{\rowmaxlPx}{\rowdlPx}%
			\dtlifnumeq{\rowminlPx}{0}{1}{} &
			\FPsub\rowminlPx{\rowmaxlPx}{\rowdlPx}%
			\FPsub\rowminlPy{\rowmaxlPy}{\rowdlPy}%
			...
			\FPadd\rowsumlPx{\rowminlPx}{\rowmaxlPx}%
			\FPdiv\rowavglPx{\rowsumlPx}{2}%
			\FPsub\rowdeltaavg{\rowavglPy}{\rowavglPx}%
			\num[round-precision = 1]{\rowdeltaavg} & %
			\FPsub\rowdelta{\rowdlPx}{\rowdlPy}%
			\num{\rowdelta} &%
			\FPsub\rowminlPx{\rowmaxlPx}{\rowdlPx}%
			\FPsub\rowminlPy{\rowmaxlPy}{\rowdlPy}%
			\FPsub\rowdeltamin{\rowminlPy}{\rowminlPx}%
			\FPsub\rowdeltaminminusone{\rowdeltamin}{1}%
			\FPsub\rowdeltaminminustwo{\rowdeltamin}{2}%
			\FPmul\rowtakendouble{\rowdeltaminminusone}{\rowdeltaminminustwo}%
			\FPdiv\rowtaken{\rowtakendouble}{2}%
			\FPadd\rowstart{\rowtaken}{1}%
			\FPsub\rowdeltamax{\rowmaxlPy}{\rowmaxlPx}%
			\FPsub\rowdeltamaxminusone{\rowdeltamax}{1}%
			\FPadd\rowcltop{\rowstart}{\rowdeltamaxminusone}%
			\dtlifnumeq{\rowminlPx}{0}{%
				\FPadd\rowclbutsixteen{\rowcltop}{0}%
			}{%
				\FPadd\rowclbutsixteen{\rowcltop}{10}%
			}%
			\dtlifnumeq{\rowclbutsixteen}{16}{%
				\FPsub\rowcl{\rowclbutsixteen}{1}%
			}{%
				\FPadd\rowcl{\rowclbutsixteen}{0}%
			}%
			\num{\rowcl} &
			\FPsub\rowminlPx{\rowmaxlPx}{\rowdlPx}%
			\FPadd\rowsumlPx{\rowminlPx}{\rowmaxlPx}%
...
%			(\num{\rowminlPx}, \num{\rowmaxlPx}, \num[round-precision = 1]{\rowavglPx}) & %
			...
			\dtlifnumgt{\rowsumlPy}{12}{!!}{}%
%			(\num{\rowminlPy}, \num{\rowmaxlPy}, \num[round-precision = 1]{\rowavglPy})
%			\newcommand{\rowRef}{ex\arabic{\rowminlPx}6}
%			\ref{\rowRef}
%			\arabic{\num{\rowminlPx}}
		}\\
		\bottomrule
