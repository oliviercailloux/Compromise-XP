...
\begin{enumerate}
	...
	\begin{itemize}
		\item 0324 (\ref{ex:0324}) VS 1435 (\ref{ex:1435})
		\item 0526 (\ref{ex:0526}) VS 1637 (\ref{ex:1637}, not taken)
	\end{itemize}
	\item Does the best position of the FB winner matter?
	\begin{itemize}
		\item 0324 (\ref{ex:0324}) VS 3657 (\ref{ex:3657})
	\end{itemize}
	\item Does $d(\lprof(y))$ matter, fixing $\delta$?
	\begin{itemize}
		\item{} [0546 (\ref{ex:0546}) or 1657 (\ref{ex:1657})] VS 0647 (\ref{ex:0647})
	\end{itemize}
...
\end{enumerate}
As a consequence, we pick the following set of seven profiles: $\set{0324 (\ref{ex:0324}), 0526 (\ref{ex:0526}), 0657 (\ref{ex:0657}), \allowbreak 1435 (\ref{ex:1435}), \allowbreak 3657 (\ref{ex:3657}), \allowbreak 0546 (\ref{ex:0546}), 0647 (\ref{ex:0647})}$.
